...
let e0 = jacobi_hamiltonian jjup_sat_sys

let _ = 
  let {ms = (m1,m2,_);
       qs = (_,qjup,_);
       vs = (_,vjup,_)} = jjup_sat_sys in 
...
let _ = test_integrator jacobi_dkd "output/kepler-dE/dkd.dat"
let _ = test_integrator jacobi_s4b "output/kepler-dE/s4b.dat"
let _ = test_integrator jacobi_s6b "output/kepler-dE/s6b.dat"
let _ = test_integrator variational_evolve "output/kepler-dE/var.dat"
