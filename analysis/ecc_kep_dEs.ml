...
let e0 = jacobi_hamiltonian jecc_jup_sat_sys

let _ = 
  let {ms = (m1,m2,_);
       qs = (_,qjup,_);
       vs = (_,vjup,_)} = jecc_jup_sat_sys in 
...
let _ = test_integrator jacobi_dkd "output/ecc-kepler-dE/dkd.dat"
let _ = test_integrator jacobi_s4b "output/ecc-kepler-dE/s4b.dat"
let _ = test_integrator jacobi_s6b "output/ecc-kepler-dE/s6b.dat"
let _ = test_integrator variational_evolve "output/ecc-kepler-dE/var.dat"
